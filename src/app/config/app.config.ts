export let appConfiguration = {
  ...
  predictionSupportedCurrencies: ['USD - United States dollar', 'EUR - European euro', 'INR - Indian rupee', 'GBP - Pound sterling', 'CNY - Chinese Yuan Renminbi', 'AUD - Australian dollar', 'CAD - Canadian dollar', 'HKD - Hong Kong dollar'],
